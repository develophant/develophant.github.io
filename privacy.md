...
- __Application__ refers to Longest River, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Longest River.
...
- By email: hello@develophant.com
